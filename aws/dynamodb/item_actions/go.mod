module github.com/mauri-codes/go-modules/aws/dynamodb/item_actions

go 1.23.2

replace github.com/mauri-codes/go-modules/aws/dynamodb/definitions => ../definitions
...
require (
	...
	github.com/mauri-codes/go-modules/aws/dynamodb/definitions v0.0.0-00010101000000-000000000000
)
